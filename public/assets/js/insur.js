(function ($) {
  ...
  /** Pause autoplay on hover, resume on mouse leave (e.g. brand carousel) */
  function brandSwiperAutoplayHoverPause() {
    document.querySelectorAll(".brand-swiper-autoplay").forEach(function (slider) {
